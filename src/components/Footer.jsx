...
<<<<<<< HEAD
  return (
    <div className="min-h-[20vh] px-6 py-12 flex flex-col lg:flex-row justify-between gap-10 items-start md:items-center text-[#002F6C] font-semibold bg-gray-400">
    ...
    return (
        <div className='min-h-[20vh] px-6 py-12 flex flex-col lg:flex-row justify-between gap-10 items-start md:items-center text-white font-semibold bg-gray-800'>
            ...
            <ul className='flex flex-col lg:flex-row items-start md:items-center gap-4'>
                ...
                <li><Link to={"/survey"} className='hover:underline'>GIVE FEEDBACK</Link></li>
            </ul>
        </div>
    )
}
>>>>>>> 7efc59771b8afdda6f334050d2d9cb96cb8ef618
