  ...
  return (
    <div className='flex flex-col md:flex-row items-center justify-center w-full my-8 px-4 md:px-24 lg:px-36 gap-12 md:gap-3'>
        <div className="md:w-1/2 flex justify-center">
            <img src={benefit_1} alt="Benefit 1" className='w-[300px] h-[300px] md:w-[400px] md:h-[400px] object-cover' />
        </div>
        <div className="md:w-1/2 space-y-7">
            <h1 className='font-bold text-xl md:text-3xl'>Care Dental Plan</h1>
            <p className='md:text-xl'>The Care Dental Plan is a comprehensive discount program designed to help you save on dental services at Annapolis Dental Center.</p>
