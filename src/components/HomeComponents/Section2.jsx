  ...
  return (
    <div className='flex flex-col md:flex-row items-center justify-center w-full my-8 px-4 md:px-24 lg:px-36 gap-12 md:gap-3'>
        <div className="md:w-1/2 flex justify-center md:order-2">
            <img src={benefit_2} alt="Benefit 1" className='w-[300px] h-[300px] md:w-[400px] md:h-[400px] object-cover' />
        </div>
        <div className="md:w-1/2 space-y-7 md:order-1">
            <h1 className='font-bold text-xl md:text-3xl'>You will Enjoy All These!</h1>
            <p className='md:text-xl'>Our plan is built to suit you and your family’s needs, providing affordable dental care that makes financial sense. With the Care Dental Plan, you’ll enjoy:</p>
