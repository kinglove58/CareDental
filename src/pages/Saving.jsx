  ...
  return (
    <div className="bg-gray-200">
      ...
      <div className="px-4 md:px-24 lg:px-36 py-8">
        <h2 className="text-2xl font-bold mb-4 text-center">Sample Savings</h2>
        <div className="overflow-x-auto ">
          <table className="min-w-full bg-white border border-gray-300 rounded-lg ">
            <thead className="text-blue-700">
              <tr>
                <th className=" border-b ">Procedure</th>
                <th className="py-2 px-2 border-b">Average Cost**</th>
                <th className="py-2 px-2 border-b">Care Dental</th>
                <th className="py-2 px-2 border-b">Member Saving</th>
              </tr>
            </thead>
            <tbody>
              <tr>
              ...
              <tr>
                <td className="py-2 px-4 border-b">Comprehensive Oral Exam</td>
                <td className="py-2 px-4 border-b">$106</td>
                <td className="py-2 px-4 border-b">$50</td>
                <td className="py-2 px-4 border-b">$56</td>
              </tr>
              <tr>
              ...
              <tr>
                <td className="py-2 px-4 border-b">
                  Filling – One Surface Resin (White) Filling, Front (Anterior)
                  Tooth
                </td>
              ...
              <tr>
                ...
                <td className="py-2 px-4 border-b">$335</td>
              </tr>
              <tr>
                <td className="py-2 px-4 border-b">
              ...
              <tr>
                ...
                <td className="py-2 px-4 border-b">$2,445</td>
              </tr>
            </tbody>
          </table>
        </div>
